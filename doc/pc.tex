...
or
  (iii) a chaotic or aperiodic trajectory,
      e.g., \reffig{cobweb}(f).
We only consider the first two cases here.
...
\begin{theorem}
  ...
  are linearly related by % \refeq{xcp},
  $\lambda \, C_p(\vx) = \sum_{q \in \Pset} T_{pq}(R) \, C_q(\vx)$,
...
&
  \hcancel {
    \big[ (R-1)^3 + X \big]
    \big[ (R^3 - X)^2 - (3R+1)^2 X \big]
    \big[ \big(R(R-1)^2-1-X\big)^2-(R-2)^2 X \big]
  }
\big[
...
is the number of simple square-free cyclic polynomials.
%
The change of variable $\lambda \rightarrow 2^n X$ and
...
\hcancel{
  \big(
    \T^6 + 3 \T^5 + 9 \T^4 + 27 \T^3 + 67\T^2 + 89 \T + 43
  \big)
} \\
&\hcancel{
  \big(
    \T^6 - 25 \T^5 + 261 \T^4 -1457 \T^3 + 4589 \T^2 - 7737 \T +5461
  \big)
} \\
&\hcancel{
  \big(
    -\T^{63} + 128 \T^{62} - \dots
    + 978621573341\dots3892330031361
    %+ 97862157334118736160267353892330031361
  \big)
} \\
\big(
...
%\vspace{1mm}
$\begin{aligned}
-&\T^{8127} + 16252 \T^{8126} - 132031248 \T^{8125} \\
+&\dots
+234550833883692
\dots
06625000000000000\T
...
\multicolumn{2}{p{\textwidth}}{
$^\dagger$
The factors from half-cycles (see \refsec{halfcycle}) are struck out.
}\\
\multicolumn{2}{p{\textwidth}}{
$^\ddagger$
...
$\begin{aligned}
&(r^6 + r^3 + 1)
(64 r^6 - 576 r^5 + 2160 r^4 - 4328 r^3 + 4896 r^2 \\
&- 2970 r + 757)
(65536 r^{24} + 196608 r^{23} - \dots + 328385156401) \cdots\\
&(100257396069318593562485\dots27041918452769115602944 r^{9792} \\
&+\dots+100777071891533412274\dots669779415034840760335533)
\end{aligned}$
&
$\begin{aligned}
&4205099973631272542535\dots26734123312649890430976 r^{9828} \\
&-619915838112722198220\dots14445875084684733448192 r^{9826} \\
&+\dots+186361973456670282\dots45890460766629265408 r^{3} \\
&+279917391437103331960\dots789652523552928732020736
\end{aligned}$
\\
%
%
...
$9$     & $2.3651805877_{9792}$ &  $2.3652188703_{9828}$  & 1092 \\
\hline
\multicolumn{4}{p{\linewidth}}{
$^\dagger$
